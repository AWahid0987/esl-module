...
class HrEmployee(models.AbstractModel):
    ...
    def _attendance_action_change(self, longitudes, latitudes):
        ...
        # Only try to get location if coordinates are provided
        ...
        if self.attendance_state != 'checked_in':
            vals = {
                ...
                'checkin_latitude': latitudes or False,
                'checkin_longitude': longitudes or False,
                'checkin_location': "https://www.google.com/maps/search/?api=1&query=%s,%s" % (
                    latitudes, longitudes) if (latitudes and longitudes) else False,
            }
        ...
        if attendance:
            attendance.write({
                ...
                'checkout_latitude': latitudes or False,
                'checkout_longitude': longitudes or False,
