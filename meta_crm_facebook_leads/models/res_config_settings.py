...
class ResConfigSettings(models.TransientModel):
    ...
    crm_fb_app_id = fields.Char('App ID', config_parameter='meta_crm_facebook_leads.crm_fb_app_id')
    crm_fb_app_secret = fields.Char('App Secret', config_parameter='meta_crm_facebook_leads.crm_fb_app_secret')
    crm_fb_access_token = fields.Char('Access Token', config_parameter='meta_crm_facebook_leads.crm_fb_access_token')
